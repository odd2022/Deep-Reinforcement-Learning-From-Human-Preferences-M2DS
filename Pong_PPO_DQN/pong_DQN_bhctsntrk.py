...
if __name__ == "__main__":
    if TRAIN_MODEL:
        environment = gym.make(ENVIRONMENT)  # No render during training
    else:
        environment = gym.make(ENVIRONMENT, render_mode="human")  # Render during evaluation
    ...
    for episode in range(startEpisode, MAX_EPISODE):
        ...
        for step in range(MAX_STEP):
            ...
            if done:  # Episode completed
                ...
                # Log total reward in TensorBoard
